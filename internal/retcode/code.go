...
var (
	...
	CreateFieldFail   = NewCode("101209", "Create Redis Key Field Fail")
	PatchFieldFail    = NewCode("101210", "Patch Redis Key Field Fail")
	NotSupportKeyType = NewCode("101299", "Not Support Redis Key Type")
